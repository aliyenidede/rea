...
`templates/` holds the redesign-era install-artifacts — `AGENTS.md`, the per-tool shims, and the
`.rea/` scaffold — that the future `npx` installer places into a **host project**. These files are
